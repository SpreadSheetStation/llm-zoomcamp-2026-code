...
This section maps directly to the [project.md evaluation criteria](https://github.com/DataTalksClub/llm-zoomcamp/blob/main/project.md#evaluation-criteria) to make scoring easy.
